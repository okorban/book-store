function validate(){
    ...
    if(!loginRegex.test(login.value)){
        login.style.backgroundColor = "#fac0c0";
        infoText = infoText + "Niepoprawny login (miinmum 5 znaków) <br>";
        result = false;
    } else {
    ...
    if(!nameRegex.test(name.value)){
        ...
        infoText = infoText + "Niepoprawne imie (minimum 3 znaki, wielka litera na początku) <br>";
        result = false;
    } else{
    ...
    if(!surnameRegex.test(surname.value)){
        ...
        infoText = infoText + "Niepoprawne nazwisko (minimum 2 znaki, wielka litera na początku) <br>";
        result = false;
    } else{
    ...
    if(!passwordRegex.test(password.value)){
        ...
        infoText = infoText + "Niepoprawne haslo (minimum 5 znaków, minimum 1 cyfra) <br>";
        result = false;
    } else{
    ...
    if(password.value != password2.value){
        ...
        infoText = infoText + "Niepoprawne powtorzone haslo<br>";
        result = false;
    } else{
