...
public class BookRepository implements IBookDAO {
    ...
    public BookRepository() {
        this.books.add(new Book(1, "Java. Podręcznik na start", "Krzysztof Korcz",
                "978-83-289-1024-9", 44.85, 10));
        this.books.add(new Book(2, "Java. Kompendium programisty. Wydanie XII", "Herbert Schildt",
                "978-83-832-2157-1", 129.35, 10));
        this.books.add(new Book(3, "Java. Rusz głową! Wydanie III", "Kathy Sierra, Bert Bates, Trisha Gee",
                "978-83-283-9985-3", 96.85, 10));
        this.books.add(new Book(4, "Java. Przewodnik doświadczonego programisty. Wydanie III", "Cay S. Horstmann",
                "978-83-289-0141-4", 57.84, 10));
    }
